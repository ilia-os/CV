...
* [organitz](https://organitz.com) - Played a pivotal role in the modernization efforts of a legacy PHP project, originally derived from an outdated version of kimai2. Led the overhaul of the user interface for improved usability and aesthetics, while also taking charge of architecting discussions and spearheading the development of a companion mobile app. Navigated through substantial legacy constraints and successfully revitalized both the web and mobile interfaces, ensuring seamless user experiences and the continued relevance of the application in today's technological landscape.
